/datum/trade_station/McRonalds
	...
	offer_types = list(
		...
		/obj/item/reagent_containers/food/snacks/meat/roachmeat/jager = offer_data("jager roach meat", 350, 0),
		/obj/item/reagent_containers/food/snacks/meat/roachmeat/fuhrer = offer_data("hauptmann roach meat", 450, 5), //Caps it
